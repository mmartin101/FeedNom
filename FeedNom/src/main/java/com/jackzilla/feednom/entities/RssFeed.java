...
// KEEP INCLUDES END
/**
 * Entity mapped to table RSS_FEEDS.
 */
public class RssFeed {
    ...
    public RssFeed(Long id, String title, String description, String link, String lastPublished, String imagePath, String httpSource) {
        this.id = id;
        this.title = title;
